...
public class TentangAktivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		teksView.setText("Anda bisa kirimkan masukkan melalui bahram7160@gmail.com");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup kontainer,
			...
			View akarView = inflater.inflate(R.layout.fragmen_tentang,
											 kontainer, false);
			return akarView;
        }
    }
